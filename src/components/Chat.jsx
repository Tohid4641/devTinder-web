...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        socketClient.on("receivedMessage", ({ firstName, userId, targetUserId, message }) => {
            // console.log(`${firstName}: ${message}`);
            setReceivedMessage(message);

            setMessages((messages) => [...messages, { firstName, userId, targetUserId, message }])
        })
        ...
        <div className="container mx-auto h-screen max-w-2xl flex flex-col">
            ...
            <div className="bg-base-200 p-4 rounded-t-lg">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-lg font-bold">TargetUserName</h3>
